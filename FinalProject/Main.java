...
public class Main {
    public static void main(String[] args) {
        ...
        jeniskamar.AddTotalKamar(total);
        jeniskamar.setTotalKamar(total);
            ...
            if(choice == 1) {
                ...
                if(choiceTamu == 1) {
                    ...
                    while(i <= brpTamu) {
                        ...
                        tamu.setTglBooking(JOptionPane.showInputDialog("Tanggal booking anda hari ini : "));
                        pt.setTglCheckIn(JOptionPane.showInputDialog("Masukkan tanggal Check-In kamu (tanggal-bulan-tahun) : "));
                        tamu.getcheckIn();  
                        choices = true;
                        while(choices) {
                            try {
                        ...
                        if(jeniskamar.getTotalKamar().get(tamu.getJenisKamar()-1) < tamu.getJumlahKamar()) {
                        ...
                        pt.tambahkanTamu(tamu.getNama(), tamu.getNoTelp(), tamu.getCustomerType(), tamu.getTglBooking(), tamu.getJumlahKamar(), tamu.getJenisKamar(), tamu.getDataAnda(), tamu.getStatus(), tamu.getNoKamar());
                        admin.tambahkanTamu(tamu.getNama(), tamu.getNoTelp(), tamu.getCustomerType(), tamu.getTglBooking(), tamu.getJumlahKamar(), tamu.getJenisKamar(), tamu.getDataAnda(), tamu.getStatus(), tamu.getNoKamar());                        
                        tamuList.add(tamu);
                        pt.TotalHarga(tamu);
                        tampil = pt.tampilkanBooking();
                        JOptionPane.showMessageDialog(null, tampil);
                        kamar.pertambahanNoKamar(tamuList);
                        jeniskamar.penguranganKamar(tamuList);
