...
class Tamu {
    ...
    // REVIEW jumlah kamar
    public Tamu(String Nama, String noTelp, String customerType, String tanggalBooking, int jumlahKamar, int jenisKamar, String DataAnda, boolean checkIn, String noKamar) {
        this.Nama = Nama;
        this.noTelp = noTelp;
